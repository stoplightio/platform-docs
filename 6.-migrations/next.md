...
| [Docs: Versioning](https://roadmap.stoplight.io/c/60-multiple-branches)                               |  Done  | Show/hide specific branches in each project's docs                                                                                        |
| [Docs: Table of Contents ordering](https://roadmap.stoplight.io/c/59-customize-docs-sidebar-ordering) | In progress  | Completely custom ordering of your docs sidebar. By default, files will be organized alphabetically, matching the order in the filesystem |
