...
If changes are not publishing, you can look at Webhook Events to debug the problem. Maybe it's a [firewall](../2.-workspaces/h.whitelisting-ips.md) issue, or webhooks are not being triggered at all.
